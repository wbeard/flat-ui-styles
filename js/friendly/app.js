define(["c8/ps", "c8/log"],
    function (ps, log) {
        ...
        var _fetchInstance = function (prop) {
            if (!prop) {
        ...
        var _fetchRemote = function (prop) {

        };

        var _fetchSessionStorage = function (prop) {
            if (sessionStorage) {
                if (!prop) {
                ...
                this.init().fetchsessionStorage();
            }
        };

        var _eventSetup = function () {
            ps.subscribe("appModelTrigger", this.fetch({ remote: true }));
        };
        ...
        return {
            ...
            init: function () {
                ...
                _eventSetup.call(this);
                return this;
            },
            persist: function () {
                if (sessionStorage) {
                    for (var key in this.properties) {
                        sessionStorage.setItem(key, this.properties[key]);
                    }
                }
                else {
                    this.init().persist();
            ...
            fetch: function (obj) {
                if (obj.prop) {
                    if (obj.forceRemote) {
                        return _fetchRemote.call(this, obj.prop);
                    }
                    else {
                        return _fetchSessionStorage.call(this, obj.prop) || _fetchInstance.call(this, obj.prop) || _fetchRemote.call(this, obj.prop);
                    }
                }
                else {
                    if (obj.forceRemote) {
                        return _fetchRemote.call(this);
                    }
                    else {
                        return _fetchSessionStorage.call(this) || _fetchInstance.call(this) || _fetchRemote.call(this);
                    }
                }
            },
            ...
            set: function (obj) {
                if (typeof obj === "object") {
                    ...
                    this.properties[obj] = arguments[1];
                }
            },
            properties: {
                /* A list of logic properties we can use on the client.
                ste: 1,
                userName: "Melinda Smith",
                clientName: "Walton County"
                */
            }
        };
